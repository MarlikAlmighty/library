...
// WithDefaults hydrates default values in the home params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HomeParams) WithDefaults() *HomeParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the home params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HomeParams) SetDefaults() {
