...
import (
	...
	"github.com/MarlikAlmighty/library/restapi/operations/bookcases"
	"github.com/MarlikAlmighty/library/restapi/operations/books"
	"github.com/MarlikAlmighty/library/restapi/operations/home"
)

//go:generate swagger generate server --target ../../library --name LibraryAPI --spec ../swagger-api/swagger.yml --principal interface{}

func configureFlags(api *operations.LibraryAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.LibraryAPIAPI) http.Handler {
