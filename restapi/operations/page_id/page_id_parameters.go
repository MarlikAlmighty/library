...
// NewPageIDParams creates a new PageIDParams object
...
// PageIDParams contains all the bound params for the page ID operation
// typically these are obtained from a http.Request
//
// docs:parameters pageID
...
func (o *PageIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PageIDParams) validateID(formats strfmt.Registry) error {
