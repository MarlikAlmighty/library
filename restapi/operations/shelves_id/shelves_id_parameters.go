...
// NewShelvesIDParams creates a new ShelvesIDParams object
// no default values defined in spec.
func NewShelvesIDParams() ShelvesIDParams {

	return ShelvesIDParams{}
}

// ShelvesIDParams contains all the bound params for the shelves ID operation
// typically these are obtained from a http.Request
//
// docs:parameters shelvesID
type ShelvesIDParams struct {

	// HTTP Request Object
	HTTPRequest *http.Request `json:"-"`

	/*Get books by shelves ID.
	  Required: true
	  Minimum: 1
	  In: path
	*/
...
func (o *ShelvesIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ShelvesIDParams) validateID(formats strfmt.Registry) error {
