...
var (
	filter_Message_Do_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_Message_Do_0(ctx context.Context, marshaler runtime.Marshaler, client MessageClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Message_Do_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_Message_Do_0(ctx context.Context, marshaler runtime.Marshaler, server MessageServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Request
	var metadata runtime.ServerMetadata
...
func RegisterMessageHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MessageServer) error {
	...
	mux.Handle("GET", pattern_Message_Do_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Message_Do_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Message_Do_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterMessageHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MessageClient) error {
	...
	mux.Handle("GET", pattern_Message_Do_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Message_Do_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Message_Do_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"shelves"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Message_Do_0 = runtime.ForwardResponseMessage
)
